...
interface PerformanceMaxExperiment {
  id: number;
  name: string;
...
// Sample Data
// ──────────────────────────────────────────────────────────────
const allExperimentsData: Experiment[] = [
  {
    id: 1,
...
const customExperimentsData: Experiment[] = [allExperimentsData[0]];

const adVariationsData: AdVariation[] = [
  {
    id: 1,
...
const performanceMaxData: PerformanceMaxExperiment[] = [
  {
    id: 1,
...
// ──────────────────────────────────────────────────────────────
// Main Component – Your Exact Design + Fixed Icons
// ──────────────────────────────────────────────────────────────
